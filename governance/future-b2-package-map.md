...
| B2 Provider Identity | geschlossene nicht personenbezogene Provider-Klassen, Verantwortungs-Codes, Capability-Descriptoren und Provenienz festlegen | ADR-0058 bis ADR-0060; ratifizierte ADR-0061 | Identität beschreibt nur und autorisiert oder aktiviert nichts | keine Person, Authorization, Invocation, Runtime, Schlüssel- oder Inhaltszugriff | ADR-0061 ratifiziert; gesonderte Implementierungsfreigabe fehlt |
