...
|---|---|---|---|---|---|
| B2 Authority and Authorization | eigene B2-Authority, Grants und zustandslose Evaluation begrenzen | ADR-0058, ADR-0059 und ratifizierte ADR-0060 | keine Capability- oder Runtime-Aktivierung | kein B1-Upgrade, Provider, Datenzugriff oder persistierter Authorization State | Ratifizierung dokumentiert; gesonderte institutionelle Implementierungsfreigabe weiterhin erforderlich |
