...
| B2 Provider Authorization | ADR-0060 punktuell auf eine unveränderte institutionelle oder fachliche B2 Provider Identity anwenden | implementierte ADR-0060- und ADR-0061-Verträge; ratifizierte ADR-0062 | keine neue Autorisierungsverfassung, Invocation oder Ausführung | keine Person, Statusfelder, Providerwahl, Runtime oder Betriebsintegration | ADR-0062 ist ratifiziert, aber nicht implementierungsfreigegeben; gesonderter institutioneller Freigabebeschluss erforderlich |
