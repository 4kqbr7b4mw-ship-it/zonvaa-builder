...
implementiert und validiert. Die ratifizierten
...
nicht implementierungsfreigegeben und nicht implementiert. Der eigenständige Zweck
...
unabhängig.
Eine mögliche spätere institutionelle Freigabe könnte dauerhaft nur
