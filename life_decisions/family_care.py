...
def _questions() -> Tuple[ControlledFamilyCareQuestion, ...]:
    values = (
        ...
        ("housing", FamilyCareGapType.HOUSING_TYPE, "Wie wohnt die betroffene Person aktuell?"),
        ("support", FamilyCareGapType.SUPPORT_NEED, "Welche Hilfe braucht die betroffene Person nach der Entlassung konkret?"),
        ("care", FamilyCareGapType.EXISTING_CARE_SUPPORT, "Welche pflegerische Unterstützung besteht bereits?"),
        ("medical", FamilyCareGapType.MEDICAL_CONTACT, "Wer ist die Ansprechperson für die medizinische Nachsorge?"),
        ...
        ("representative", FamilyCareGapType.REPRESENTATIVE, "Ist geklärt, wer Entscheidungen übernehmen darf, wenn die betroffene Person das selbst nicht kann?"),
        ("family", FamilyCareGapType.FAMILY_SUPPORT, "Welche Angehörigen oder Unterstützenden sind ausdrücklich bekannt?"),
        ("roles", FamilyCareGapType.ROLE_DISTRIBUTION, "Ist geklärt, wer in der Familie welche Aufgaben übernimmt?"),
        ("finance", FamilyCareGapType.FINANCIAL_BURDEN, "Welche zusätzlichen Kosten oder finanziellen Belastungen sind bereits bekannt?"),
